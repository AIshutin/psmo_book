...
3. $P(\{\text{у матрицы $X$ есть линейно зависимые столбцы}\}) = 0$.
...
1. \textit{(релевантность)} $E(x_iz_i) \ne 0 \sim \mathrm{cov}(x_i, z_i) \ne 0 \sim \plim_{n \to \infty} Z'_jX \ne 0$.

2. \textit{(валидность)} $E(u_iz_i) = 0 \sim \mathrm{cov}(u_i, z_i) = 0 \sim \plim_{n \to \infty} Z'_ju = 0$.
